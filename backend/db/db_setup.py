...
def create_app():
    ...
    # Apply configuration
    app.config.from_object(DevelopmentConfig)  # Can be replaced with ProductionConfig for production
...
if __name__ == "__main__":
    ...
    db_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'instance', 'image_processing.db'))
